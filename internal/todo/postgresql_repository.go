...
type PostgresTodoPort struct {
	tx DatabaseTransaction
}

func NewPostgresTodoPort(dbConn DatabaseTransaction) *PostgresTodoPort {
	return &PostgresTodoPort{
		tx: dbConn,
	}
}

func (ptp *PostgresTodoPort) CreateTodo(ctx context.Context, todo *entity.Todo) (*entity.Todo, error) {
...
func (ptp *PostgresTodoPort) GetAllTodos(ctx context.Context) ([]*entity.Todo, error) {
...
func (ptp *PostgresTodoPort) DeleteTodo(ctx context.Context, id int) (*int, error) {
